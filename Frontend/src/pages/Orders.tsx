...
const Orders = () => {
  ...
  <div>
    ...
    <div className="max-w-5xl mx-auto px-2 md:px-4">
      ...
      <div key={index} className="bg-white border border-gray-300 rounded-sm p-2 md:p-4 flex justify-between items-center md:justify-start md:items-start gap-2 md:gap-4 shadow-sm shadow-zinc-300 hover:cursor-pointer">
        ...
        <div className="flex gap-2 flex-col justify-center items-start md:flex-row md:w-full md:justify-between">
          ...
          <div className="flex flex-col justify-start items-start gap-3  max-w-sm">
            <p className="font-medium">Lenovo IdeaPad 3</p>
          ...
          <p className="font-medium">{formatCurrency(2234)}</p>
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-start items-center gap-2 text-xs md:text-sm font-medium">
              ...
              <p>Cancelled on {"Apr 18, 2024"}</p>
            </div>
            <p className="text-xs text-gray-500">You order has been cancelled</p>
          </div>
